...
dataaccess
    : DATAACCESS OPEN_BRACE properties CLOSE_BRACE
    ;
...
dictionary_initializer
    : OPEN_BRACE dictionary_pairs CLOSE_BRACE
    | OPEN_BRACE CLOSE_BRACE
    ;

dictionary_pairs
    : dictionary_pair (COMMA dictionary_pair)*
    ;

dictionary_pair
    : OPEN_BRACE identifier COMMA literal CLOSE_BRACE
    ;

literal_list
    : OPEN_BRACE literal_list_items CLOSE_BRACE
    | OPEN_BRACE CLOSE_BRACE
    ;
